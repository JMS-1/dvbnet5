...
namespace JMS.DVB.Algorithms.Scheduler
{
    ...
    public static class CustomComparer
    {
        ...
        {
            // Forward
            return Create(Encoding.ASCII.GetBytes(@"
        ...
        internal static IComparer<SchedulePlan> Create(byte[] fileContents, IEqualityComparer<string> nameComparer)
        {
            ...
            using (var reader = new StreamReader(stream, true))
                for (string line; (line = reader.ReadLine()!) != null;)
                {
                    ...
                    if (parts.Length != 2)
                        throw new InvalidDataException(string.Format("Schedule Rule must be of Format &lt;property&gt;:&lt;order&gt; but is '{0}'", data));
                            ...
                            case "ByPriority":
                                {
                                    ...
                                    switch (parts[1])
                                    {
                                        ...
                                        default: throw new InvalidDataException(string.Format("Property '{0}' is not compatible with Order '{1}'", parts[0], parts[1]));
                                    }
                            ...
                            case "ByPriority":
                                {
                                    ...
                                    switch (parts[1])
                                    {
                                        ...
                                        default: throw new InvalidDataException("Schedule Rule 'ByPriority:End' missing");
                                    }
            ...
            // Validate
            if (resourceComparer != null)
                throw new InvalidDataException("Schedule Rule 'ByPriority:End' missing");
