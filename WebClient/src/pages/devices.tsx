    ...
    render(): JSX.Element {
        return (
            <div className='vcrnet-devices'>
                ...
                <HelpLink topic='tasks' page={this.props.uvm} /> wie etwa die Aktualisierung der Programmzeitschrift
    ...
    private getHelp(): JSX.Element {
        return (
            <InlineHelp title='Erläuterungen zur Bedienung'>
                ...
                darf
                <HelpLink topic='devices' page={this.props.uvm} />. Führt ein Gerät gerade eine oder mehrere
                ...
                <HelpLink topic='parallelrecording' page={this.props.uvm} /> Aufzeichnungen aus, so wird als Größe die
                ...
                <HelpLink topic='log' page={this.props.uvm} />.
            </InlineHelp>
        )
    }
}
