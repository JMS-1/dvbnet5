        ...
        protected renderSection(): JSX.Element {
            return (
                <div className='vcrnet-admin-devices'>
                    ...
                    <HelpLink topic='dvbnet' page={this.props.uvm.page} /> Geräteprofile für Aufzeichnungen verwendet
                    werden dürfen. Eines dieser Geräte muss dann als bevorzugtes Gerät festgelegt werden.
                    {this.getHelp()}
                    <form>
        ...
        private getHelp(): JSX.Element {
            return (
                <InlineHelp title='Erläuterungen zur Bedienung'>
                    ...
                    Spalte können beliebig viele davon für Aufzeichnungen durch den VCR.NET Recording Service
                    freigeschaltet werden. Eines dieser Geräte muss dann zusätzlich als bevorzugtes Gerät festgelegt
                    werden. Dieses bevorzugte Gerät wird zum Beispiel bei neuen Aufträgen aber auch beim Aufruf der
                    Programmzeitschrift als Vorauswahl verwendet.
                    <br />
                    <br />
                    ...
                    verwendet. Grundsätzlich werden Änderungen in der Tabelle erst durch eine explizite Bestätigung über
                    die entsprechende Schaltfläche übernommen. Änderungen an den Geräten erfordern fast immer einen
