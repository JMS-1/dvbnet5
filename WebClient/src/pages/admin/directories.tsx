    ...
    protected renderSection(): JSX.Element {
        return (
            <div className='vcrnet-admin-directories'>
                ...
                diesen Zweck separate Verzeichnisse festzugelegen. Dadurch können dann zum Beispiel gesonderte
                Festplatten oder Partitionen für Aufzeichnungen genutzt werden. Zusätzlich kann hier definiert werden,
    ...
    private getFolderHelp(): JSX.Element {
        return (
            <InlineHelp title='Erläuterungen zur Bedienung'>
                ...
                betrifft: sollten diese ein Aufzeichnungsverzeichnis verwenden, dass nicht mehr zugelassen ist, so kann
                die Aufzeichnung nicht durchgeführt werden.
            </InlineHelp>
        )
    }
    ...
    private getAddHelp(): JSX.Element {
        return (
            <InlineHelp title='Erläuterungen zur Bedienung'>
                ...
                Eingabe eines Netzwerkpfades erweitert werden. Die Navigation durch die Verzeichnisstruktur des
                Rechners, auf dem der VCR.NET Recording Service läuft, erfolgt unmittelbar durch Auswahl eines
                Unterverzeichnisses in der angebotenen Liste. Mit der Schaltfläche direkt darunter kann auf das jeweils
                übergeordnete Verzeichnis zurück gewechselt werden.
                <br />
                <br />
                Wird das Hinzufügen eines Verzeichnisses gewählt, so wird die Eingabe eines Netzwerkverzeichnisses
                bevorzugt verwendet. Dabei wird dann zusätzlich geprüft, ob das eingegebene Verzeichnis auch vom VCR.NET
                Dienst angesprochen werden kann. Ist dies der Fall, so wird es in die Liste der
                Aufzeichnungsverzeichnisse übernommen und ansonsten ein Fehler angezeigt. Ist die Eingabe leer, so wird
                das ausgewählte Verzeichnis des Servers übernommen.
                <br />
                <br />
                Die Übernahme der Änderungen erfolgt erst, wenn dies durch Auswahl der entsprechenden Schaltfläche
                explizit angefordert wird. Ist zu diesem Zeitpunkt die Liste der Aufzeichnungsverzeichnisse leer, so
                wird ein Verzeichnis im Installationsverzeichnis des VCR.NET Recordings Service verwendet - es wird aber
                dringend empfohlen, immer mindestens ein Aufzeichnungsverzeichnis festzulegen. Änderungen an den
                Aufzeichnungsverzeichnissen oder dem Namensmuster für Aufzeichnungsdateien erfordern keinen Neustart des
                VCR.NET Dienstes.
            </InlineHelp>
        )
    }
    ...
    private getPatternHelp(): JSX.Element {
        return (
            <InlineHelp title='Mögliche Platzhalter in den Dateinamen'>
                ...
                ohne Einbeziehung des Zeitpunktes der Aufzeichnung kann es etwa leicht dazu kommen, dass eine
                Aufzeichnung die Aufzeichnungsdatei eine frühere Ausführung überschreibt.
                <br />
                <br />
                <table className='vcrnet-admin-pattern'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <em>MultiLang</em>, wenn alle MP2 Sprachen mit aufgezeichnet wurden, sonst leer
                            </td>
                        </tr>
                        <tr>
                            <td>%AC3%</td>
                            <td>&nbsp;</td>
                            <td>
                                <em>AC3</em>, wenn der Dolby Digital Ton mit aufgezeichnet wurde, sonst leer
                            </td>
                        </tr>
                        <tr>
                            <td>%TTX%</td>
                            <td>&nbsp;</td>
                            <td>
                                <em>TTX</em>, wenn der Videotext mit aufgezeichnet wurde, sonst leer
                            </td>
                        </tr>
                        <tr>
                            <td>%DVBSub%</td>
                            <td>&nbsp;</td>
                            <td>
                                <i>DVBSUB</i>, wenn DVB Untertitel mit aufgezeichnet wurden, sonst leer
                            </td>
                        </tr>
                        <tr>
                            <td>%StationFull%</td>
