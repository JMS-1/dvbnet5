    ...
    render(page: App.IPage): JSX.Element {
        return (
            <div>
                ...
                <JMSLib.ReactUi.InternalLink view={page.application.adminPage.route} pict='admin' />, die hier kurz
                ...
                <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};security`} pict='admin' />,
                welche Anwender Aufzeichnungen programmieren dürfen und welchen Anwendern zusätzlich die Konfiguration
                des VCR.NET Recording Service gestattet wird.
                <br />
                <br />
                Es empfiehlt sich unbedingt mindestens ein Verzeichnis zu bestimmen
                <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};directories`} pict='admin' />,
                in dem die Aufzeichnungsdateien abgelegt werden - nach der Installation wird ein Unterverzeichnis des
                ...
                werden
                <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};devices`} pict='admin' />, eine
                beliebige Anzahl davon zu verwenden. Dazu werden die entsprechenden DVB.NET Geräteprofile in einer
                Auswahlliste markiert und eines davon als Voreinstellung ausgezeichnet.
                <br />
                <br />
                ...
                <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};other`} pict='admin' /> - man
                beachte allerdings, dass eine Umschaltung einen erneuten Aufruf des Browsers mit dem veränderten Port
                erforderlich macht.
                <br />
                <br />
                Zusätzlich ist es möglich, den Umfang der Protokollierung einzustellen
                <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};other`} pict='admin' />, die der
                VCR.NET Recording Service im Ereignisprokoll von Windows (Bereich Anwendung) vornimmt.
            </div>
        )
    }
}
