    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                <InternalLink view={page.application.adminPage.route} pict='admin' />, die hier kurz vorgestellt werden
                sollen.
                <br />
                <br />
                ...
                <InternalLink view={`${page.application.adminPage.route};security`} pict='admin' />, welche Anwender
                ...
                <InternalLink view={`${page.application.adminPage.route};directories`} pict='admin' />, in dem die
                ...
                werden
                <InternalLink view={`${page.application.adminPage.route};devices`} pict='admin' />, eine beliebige
                ...
                <InternalLink view={`${page.application.adminPage.route};other`} pict='admin' /> - man beachte
                ...
                <InternalLink view={`${page.application.adminPage.route};other`} pict='admin' />, die der VCR.NET
