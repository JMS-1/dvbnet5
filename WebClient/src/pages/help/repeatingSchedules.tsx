    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                Recording Service bietet hier die Möglichkeit, die Wochentage auszuwählen, an denen die Aufzeichnung
                durchgeführt werden soll - die jeweilige Uhrzeit wird dabei beibehalten. Ergänzend kann der Tag
                angegeben werden, an dem die Aufzeichnung letztmalig auszuführen ist - ohne diese Einstellung wird die
                Aufzeichnung unbegrenzt wiederholt. Diese Eingabe ist nur möglich, wenn mindestens ein Wochentag zur
                Wiederholung aktiviert ist.
                <ScreenShot name='faq/repeating' />
                Als Besonderheit ist zu erwähnen, dass nur die Kombination aus dem Zeitpunktder ersten Aufzeichnung und
                den gewählten Wochentagen die Tage der Aufzeichnung festlegt. Würde im gezeigten Beispiel als erster
                Zeitpunkt etwa der 11. Januar 2013 gewählt, so würde die erste Aufzeichnung am 17. Januar 2013 erfolgen,
                da der Freitag kein gültiger Aufzeichnungstag ist.
                <br />
                <br />
                ...
                Liste der aktiven Ausnahmen zu entfernen und dann die Änderung zu bestätigen. Dieses Vorgehen kann auch
                zur Wiederherstellung der ursprünglichen Planung verwendet werden, wenn nur eine einfache Ausnahme
                definiert worden ist - das ginge allerdings auch direkt aus dem Aufzeichnungsplan heraus.
