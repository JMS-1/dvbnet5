    ...
    render(page: App.IPage): JSX.Element {
        return (
            <div>
                ...
                <JMSLib.ReactUi.InternalLink view={page.application.devicesPage.route} pict='devices' /> einen
                gesonderten Protokolleintrag. Eine Aktivität ist hierbei immer ein geschlossener Nutzungszeitraum eines
                DVB Gerätes. In diesem Zeitraum kann entweder eine einzelne Sonderaufgabe oder eine{' '}
                ...
                können direkt über die Web Oberfläche abgerufen werden.
                <br />
                <br />
                ...
                <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};other`} pict='admin' /> des
                VCR.NET Recording Service sieht vor, dass veraltete Protokolleinträge automatisch entfernt werden. Man
                beachte aber, dass dies nicht periodisch geschieht, sondern nur bei Aufruf der Liste über die Web
                Oberfläche.
                <br />
                <br />
                ...
                <JMSLib.ReactUi.InternalLink view={`${page.route};tasks`}>
                    Sonderaufgaben
                </JMSLib.ReactUi.InternalLink>{' '}
                hinzu zu schalten - einzeln pro Art der Aufgabe.
                <br />
                <br />
                ...
                zu einem Eintrag noch vorhanden, so wird dies durch kleine Symbole{' '}
                <JMSLib.ReactUi.Pictogram name='recording' /> bei dem Eintrag visualisiert. Ist auf dem Rechner, von dem
                die Web Oberfläche aufgerufen wurde, der{' '}
                <JMSLib.ReactUi.ExternalLink url='http://www.psimarron.net/DVBNETViewer/'>
                    DVB.NET / VCR.NET Viewer
                </JMSLib.ReactUi.ExternalLink>{' '}
                lokal installiert, so kann durch Klicken auf ein Symbol die zugehörige Aufzeichnungsdatei zur Anzeige
                geöffnet werden.
            </div>
        )
    }
