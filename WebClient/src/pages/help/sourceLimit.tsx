    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                gleichzeitig verwendeten Quellen zu beschränken. Der VCR.NET Recording Service wird dann davon ausgehen,
                ...
                trotzdem sein, dass 8 Radiosender ohne Probleme gleichzeitig aufgezeichnet werden können. Den Wert höher
                als die Voreinstellung zu setzen sollte auch in den wenigsten Situationen notwendig sein.
                <br />
                <br />
                Insgesamt kann nur empfohlen werden, die Einstellung nicht zu verändern und den gesunden
                Menschenverstand auch bei der Programmierung von Aufzeichnungen sinnvoll zu nutzen.
            </div>
        )
    }
}
