    ...
    render(page: App.IPage): JSX.Element {
        return (
            <div>
                ...
                Aktivitäten
                <JMSLib.ReactUi.InternalLink view={page.application.devicesPage.route} pict='devices' /> auf den DVB
                Geräten werden mit Hilfe der{' '}
                <JMSLib.ReactUi.ExternalLink url='http://www.psimarron.net/DVBNET/'>
                    DVB.NET Bibliothek
                ...
                <JMSLib.ReactUi.ExternalLink url='http://www.psimarron.net/DVBNET/html/profiles.html'>
                ...
                <JMSLib.ReactUi.ExternalLink url='http://www.psimarron.net/DVBNET/html/sourcescan.html'>
