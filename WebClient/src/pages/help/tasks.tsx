    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                die DVB Hardware auch für andere Zwecke nutzen.
                <br />
                <br />
                ...
                auch dem VCR.NET Recording Service zur Verfügung steht.
                <br />
                <br />
                Bei der Planung von Aufzeichnungen haben periodische Aufgaben grundsätzlich eine geringere Priorität als
                programmierte Aufzeichnungen. Würden sich etwa eine Aktualisierung und eine Aufzeichnung überschneiden,
                so wird die Aktualisierung so lange verschoben, bis ein ausreichendes Zeitfenster für die Durchführung
                gefunden wurde. Etwas anders sieht es allerdings aus, wenn bereits eine Aktualisierung aktiv ist. Wird
                im Zeitraum der Aktualisierung eine neue Aufzeichnung hinzugefügt und überschneidet sich diese mit der
                laufenden Aktualisierung, so wird die Aufzeichnung verzögert beginnen: eine einmal gestartete
                Aktualisierung wird nicht zwangsweise beendet um einer Aufzeichnung Platz zu machen.
                <br />
                <br />
                Der <em>Live</em> Modus kann in der Planung natürlich grundsätzlich nicht berücksichtigt werden. Soll
                eine Aufzeichnung stattfinden, so wird ein aktiver <em>Live</em> Modus automatisch beendet. Darüber
                hinaus ist es sogar nicht möglich, in den <em>Live</em> Modus zu wechseln, wenn eine neue Aufzeichnung
                in naher Zukunft beginnen würde. Gegenüber den Aktualisierungen hat der <em>Live</em> Modus allerdings
                Vorrang: es kann in den <em>Live</em> Modus gewechselt werden, selbst wenn eine Aktualisierung
                unmittelbar bevorsteht. Soll eine Aktualisierung stattfinden, während der <em>Live</em> Modus verwendet
                wird, so wird diese nach hinten verschoben, bis der <em>Live</em> Modus beendet wird. Während einer
                laufenden Aufzeichnung oder Aktualisierung steht der <em>Live</em> Modus grundsätzlich nicht zur
                Verfügung.
                <br />
                <br />
