    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                Oberfläche vollständig bedient werden kann. Eine Installation bringt aber auch zusätzlich eine kleine
                Anwendung mit, die <em>VCR.NET Kontrollzentrum</em>
                genannt wird. Sie wird üblicherweise automatisch beim Anmelden eines Benutzers gestartet und erscheint
                als kleines Kamerasymbol im System Tray von Windows. Normalerweise ist das Kontrollzentrum mit dem
                lokalen VCR.NET Recording Service verbunden, allerdings kann diese Konfiguration verändert und auch eine
                Verbindung mit einem Dienst auf einem anderen Rechner hergestellt werden. Es ist sogar möglich, die
                Anwendung gleichzeitig mit mehreren Rechner zu verbinden, auf denen ein VCR.NET Recording Service aktiv
                ist - in diesem Fall erscheinen dann mehrere Kamerasymbole, deren Tooltips den zugehörigen Rechner
                anzeigen.
                <br />
                <br />
                Schon das Kamerasymbol hat einen gewissen Nutzen für den Anwender: seine Hinterlegung mit einer Farbe
                zeigt an, in welchem Zustand sich der zugehörige VCR.NET Recording Service befindet. Eine{' '}
                <span className='vccRed'>rote</span> Hinterlegung bedeutet, dass keine Verbindung hergestellt werden
                konnte - bei einem lokalen VCR.NET Recording Service kann es sein, dass der zugehörige Windows Dienst
                ...
                Konfiguration der Anwendung vorausgesetzt, auf die aber nicht weiter eingegangen wird:
                <ul>
                    <li>
