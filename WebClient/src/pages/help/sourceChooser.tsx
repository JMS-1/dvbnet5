    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                kann erheblich sei: für Astra 1 auf 19.2° Ost sind es mehr als 1.000 verschiedene Quellen, aus denen
                ...
                <ul>
                    ...
                    <li>
                        ...
                        den ersten Buchstaben des Namens der Quelle erfolgen. Der Übersichtlichkeit halber erfolgt die
                        Unterteilung nicht auf Basis einzelner Buchstaben sondern auf einer Gruppierung von im
                        Allgemeinen drei aufeinanderfolgenden Buchstaben.
                    </li>
                    <li>
                        Es werden im Prinzip alle verfügbaren Quellen angezeigt. Mit den beiden Auswahllisten rechts ist
                        es dann noch möglich, sich auf Fernseh- oder Radiosender sowie verschlüsselte respektive
                        unverschlüsselte Quellen zu beschränken.
                    </li>
                </ul>
                Die Liste der zuletzt verwendeten Quellen hat bei der Auswahl eine weitere Besonderheit: in diesem
                Auswahlmodus werden keine weiteren Auswahllisten zur Einschränkung der angezeigten Quellen angeboten.
                Das macht im Allgemeinen auch Sinn, da die Anzahl der Quellen in der Liste beschränkt ist.
                <br />
                <br />
                Interessant wird es aber, wenn eine andere Auswahlmöglichkeit verwendet wird. Hier erscheinen nun zwei
                weitere Auswahllisten, wie oben im Bild auch gezeigt:
                <ul>
                    <li>
                        Es ist möglich, nur Radio- oder nur Fernsehsender zur Auswahl anzubieten - oder einfach alle
                        Quellen, aber im Allgemeinen weiß man ja, was man programmieren möchte. Auch diese
                        Voreinstellung ist individuell konfigurierbar.
                    </li>
                    <li>
                        Die Quellen können auf verschlüsselte und unverschlüsselte Quellen beschränkt werden - die
                        Beschränkung kann auch jederzeit wiederrufen werden. Die Voreinstellung kann jeder Anwender für
                        sich frei wählen.
                    </li>
                </ul>
