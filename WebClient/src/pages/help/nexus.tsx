    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                Empfangs mithalten kann. Die Erfahrung zeigt, dass zwar der gleichzeitig Empfang von RTL, RTL2, VOX und
                SuperRTL möglich wäre, nicht aber ZDF, 3Sat, KIKA und ZDF.info - immer beschränkt auf nur das Bild und
                eine Tonspur. Das ZDF überträgt seine Sender mit deutlich höheren Datenraten, was auch zu einem besseren
                Bild führt. Nach aktuellen Kenntnisstand kommt die Nexus mit einer Gesamtbildrate von etwa 14 MBit/s
                zurecht, ab etwa 15 MBit/s kommt es aber zu dramatischen Störungen, die alle parallelen Aufzeichnungen
                gleichzeitig unbrauchbar macht.
                <br />
                <br />
                Tatsächlich ist es in der Praxis bisher nicht vorgekommen, dass die Zahl gleichzeitiger Aufzeichnungen
                grundsätzlich nicht möglich war - mehr als zwei gleichzeitige Sendungen ist schon recht selten. Es
                bleibt aber immer die Beschränkung auf die 8 Nutzdatenströme, die je nach konkreter Situation von
                Unannehmlichkeiten bis zu fehlgeschlagenen Aufzeichnungen führen kann.
                <br />
                <br />
                Der VCR.NET Recording Service war eines der ersten Programme, die parallele Aufzeichnungen bei Einsatz
                einer Nexus / 2300 überhaupt erlaubten. Die ersten Versionen haben sich dabei auch große Mühe gegeben,
                die Einschränkungen der DVB Hardware bei der Aufzeichnungsplanung zu berücksichtigen und entsprechend
                ...
                <br />
                <br />
                Ein ärgerlicher Punkt in der aktuellen Implementierung darf aber nicht unerwähnt bleiben. Der VCR.NET
                Recording Service hat in der vorliegenden Version keine Möglichkeit zu protokollieren, wenn das Starten
                einer zusätzlichen Aufzeichnung aufgrund der Hardwarebeschränkung nicht möglich war. Läuft im Beispiel
                oben die volle ZDF Aufzeichnung mit 7 Datenströmen und muss eine weitere Aufzeichnung gestartet werden,
                so geschieht dies nicht. Der VCR.NET Recording Service verhält sich aber, als wäre die Aufzeichnung
                aktiviert worden.
            </div>
        )
    }
