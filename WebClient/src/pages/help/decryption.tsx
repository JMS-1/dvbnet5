    ...
    render(page: App.IPage): JSX.Element {
        return (
            <div>
                ...
                <JMSLib.ReactUi.InternalLink view={`${page.route};dvbnet`}>DVB.NET</JMSLib.ReactUi.InternalLink> nutzen,
                um mit Hilfe einer CI/CAM Hardware und einer entsprechenden Abonnementen-Karte Quellen zu entschlüsseln
                und in unverschlüsselter Form aufzuzeichnen. Im Allgemeinen sind dabei besondere Einstellungen des
                DVB.NET Geräteprofils notwendig, auf die hier aber nicht eingegangen werden kann.
                <br />
                <br />
                Eine wichtige, wenn auch zurzeit noch irrelevante Einstellung
                <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};devices`} pict='admin' /> ist
                die Anzahl der gleichzeitig entschlüsselbarer Quellen. Irrelevant ist diese Einstellung in der
                vorliegenden Version, da DVB.NET zu jeder Zeit immer nur eine Quelle entschlüsseln kann. Im DVB.NET
                Geräteprofil wird bei den Aufzeichnungseinstellungen ein entsprechender Grenzwert verwaltet, der als
                Voreinstellung 1 verwendet.
                ...
                zu jedem Zeitpunkt pro DVB Gerät maximal die festgelegte Anzahl von Quellen entschlüsselt wird. Wird
                dieser Wert auf 0 verändert, so werden Aufzeichnungen von verschlüsselten Quellen automatisch aus der
                Planung entfernt.
                <br />
                <br />
                ...
                und kann eventuell falsche Informationen enthalten, wenn die Sendeanstalten fehlerhafte Informationen
