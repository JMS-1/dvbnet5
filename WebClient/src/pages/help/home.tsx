    ...
    render(page: App.IPage): JSX.Element {
        return (
            <div>
                ...
                <JMSLib.ReactUi.Pictogram name='info' />, über das direkt zu einer passenden Erklärung gesprungen werden
                kann.
                <br />
                <br />
                ...
                <ul>
                    ...
                    <li>
                        Wann kann es{' '}
                        <JMSLib.ReactUi.InternalLink view={`${page.route};numberoffiles`}>
                            mehr als eine
                        </JMSLib.ReactUi.InternalLink>{' '}
                    ...
                    <li>
                        ...
                        für die Programmierung von Aufzeichnungen eingesetzt?
                    </li>
                    <li>
                        Wann werden Aufzeichnungen gelöscht und was ist das{' '}
                        <JMSLib.ReactUi.InternalLink view={`${page.route};archive`}>Archiv</JMSLib.ReactUi.InternalLink>
                        ?
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <JMSLib.ReactUi.InternalLink view={`${page.application.adminPage.route};directories`}>
                            Dateinamen
                        </JMSLib.ReactUi.InternalLink>{' '}
                    ...
                    <li>
                        ...
                        <JMSLib.ReactUi.InternalLink view={`${page.route};tsplayer`}>
                            Aufzeichnungsdatei
                        </JMSLib.ReactUi.InternalLink>{' '}
                        an?
                    </li>
                    <li>
                        ...
                        , welche Aufzeichnung von welcher DVB Karte ausgeführt wird?
                    </li>
                </ul>
                <h3>Aktivitäten</h3>
                <ul>
                    <li>
                        ...
                        <JMSLib.ReactUi.InternalLink view={page.application.devicesPage.route}>
                            gerade eingesetzt
                        </JMSLib.ReactUi.InternalLink>
                        ?
                    </li>
                    ...
                    <li>
                        ...
                        <JMSLib.ReactUi.InternalLink view={`${page.route};currentstream`}>
                            beeinflusst
                        </JMSLib.ReactUi.InternalLink>{' '}
                        werden?
                    </li>
                    ...
                    <li>
                        Was enthalten die{' '}
                        <JMSLib.ReactUi.InternalLink view={`${page.route};log`}>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <JMSLib.ReactUi.InternalLink view={`${page.route};sourcelimit`}>
                            beschränkt
                        </JMSLib.ReactUi.InternalLink>{' '}
                        werden?
                    </li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        bietet der VCR.NET Recording Service an?
                    </li>
                    <li>
                        Welche Rolle spielen{' '}
                        <JMSLib.ReactUi.InternalLink view={`${page.route};dvbnet`}>DVB.NET</JMSLib.ReactUi.InternalLink>{' '}
                        und die darüber definierten Geräteprofile?
                    </li>
                    <li>
                        Was sind die Web Dienste und welche{' '}
                        <JMSLib.ReactUi.InternalLink view={`${page.route};websettings`}>
