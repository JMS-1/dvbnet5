    ...
    render(page: App.IPage): JSX.Element {
        return (
            <div>
                ...
                <JMSLib.ReactUi.InternalLink view={page.application.devicesPage.route} pict='devices' /> Aufzeichnung.
                In dieser wird etwa vermerkt, wenn der Anwender den Endzeitpunkt verschiebt. Manchmal ist es wichtig zu
                verstehen, welche Veränderung den VCR.NET Recording Service beeinflussen.
                <br />
                <br />
                ...
                <JMSLib.ReactUi.InternalLink view={page.application.planPage.route} pict='plan' />. Handelt es sich um
                eine{' '}
