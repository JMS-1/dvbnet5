    ...
    render(page: IPage): JSX.Element {
        return (
            <div>
                ...
                <InternalLink view={page.application.devicesPage.route} pict='devices' /> Aufzeichnung. In dieser wird
                ...
                <InternalLink view={page.application.planPage.route} pict='plan' />. Handelt es sich um eine{' '}
