...
export interface IAdminScanPage extends ISection {
  ...
  readonly mode: list.IValueFromList<scanConfigMode>;
  ...
  readonly hours: multiList.IMultiValueFromList<number>;
...
export class ScanSection extends Section implements IAdminScanPage {
  ...
  private static readonly _scanModes = [
    list.uiValue(scanConfigMode.Disabled, "Aktualisierung deaktivieren"),
    list.uiValue(scanConfigMode.Manual, "Manuell aktualisieren"),
    list.uiValue(scanConfigMode.Automatic, "Aktualisieren nach Zeitplan"),
  ];

  // Die Art der Aktualisierung.
  readonly mode = new list.SingleListProperty(
  ...
  // Die Stunden, an denen eine Aktualisierung ausgeführt werden soll.
  readonly hours = new multiList.MultiListProperty(
