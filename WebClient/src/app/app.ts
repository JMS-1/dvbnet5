...
import {
  getServerVersion,
  IInfoServiceContract,
} from "../web/IInfoServiceContract";
import {
  getUserProfile,
  IUserProfileContract,
} from "../web/IUserProfileContract";
...
export interface IApplication {
  ...
  readonly helpPage: help.IHelpPage;
  ...
  getHelpComponentProvider<
    TComponentType extends help.IHelpComponent,
  >(): help.IHelpComponentProvider<TComponentType>;
...
export class Application implements IApplication {
  ...
  // Das Präsentationsmodell der Hilfeseiten.
  readonly helpPage: help.HelpPage;
  ...
  constructor(private _site: IApplicationSite) {
    ...
    this.helpPage = this.addPage(help.HelpPage);
  ...
  private addPage<TPageType extends Page>(factory: {
    new (application: Application): TPageType;
  }): TPageType {
