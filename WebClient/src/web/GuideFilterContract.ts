...
export function queryProgramGuide(filter: GuideFilterContract): Promise<GuideItemContract[] | undefined> {
    return doUrlCall(`guide`, `POST`, filter)
}

export function countProgramGuide(filter: GuideFilterContract): Promise<number | undefined> {
