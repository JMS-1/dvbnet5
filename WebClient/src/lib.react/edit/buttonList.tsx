...
export class SingleSelectButton extends ComponentExWithSite<
  IValueFromList<unknown>,
  ISingleSelectButton
> {
  ...
  render(): React.JSX.Element {
    return (
      <div
        className={`jmslib-editbuttonlist${this.props.merge ? " jmslib-command-mergelist" : ""}`}
      >
