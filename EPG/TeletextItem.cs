...
namespace JMS.DVB.EPG
{
    ...
    public class TeletextItem
    {
        ...
        /// <param name="offset">Das erste Byte in den Rohdaten, das zu einer Beschreibung geh�rt.</param>
        ...
        /// <summary>
        /// Die Gr��e der zugehörigen Rohdaten in Bytes.
        /// </summary>
        public int Length => 5;
        ...
        /// <param name="section">Die Rohdaten.</param>
        /// <param name="offset">Das erste Byte in den Rohdaten, das zu einer Beschreibung geh�rt.</param>
        /// <param name="length">Die Gr��e der Beschreibung in den Rohdaten.</param>
