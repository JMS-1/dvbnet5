namespace JMS.DVB.EPG.BBC
{
    ...
    public class TableCreator
    {
        ...
        /// </summary>
        public const ushort EscapeIndicator = ushort.MaxValue - 1;

        /// <summary>
        /// Zeigt das Ende einer Musterliste an.
        /// </summary>
        public const ushort EndIndicator = ushort.MaxValue - 2;
        ...
        /// </summary>
        private List<ushort> m_Table = null!;
        ...
        public uint[] CreateEncoderTable()
        {
            ...
            for (int from = 0; from <= 127; ++from)
            {
                ...
                if (!m_Transitions.TryGetValue(fromChar, out var transitions))
                    continue;
        ...
        private static int GetTableForCharacter(char from)
        {
            // Starter
            if ('\0' == from)
                return 0;
