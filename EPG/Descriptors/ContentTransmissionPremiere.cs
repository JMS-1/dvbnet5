namespace JMS.DVB.EPG.Descriptors
{
    ...
    public class ContentTransmissionPremiere : Descriptor
    {
        ...
        /// <summary>
        /// Die urspr�ngliche Netzwerkkennung.
        /// </summary>
        ...
        /// <summary>
        /// Pr�ft, ob es sich um einen Sendungsbeschreibung von PREMIERE handelt.
        /// </summary>
        /// <param name="tag">Die zu pr�fende Beschreibungsart.</param>
        /// <returns>Gesetzt, wenn es sich um die unterst�tzte Art (<i>0xF0</i>) handelt.</returns>
