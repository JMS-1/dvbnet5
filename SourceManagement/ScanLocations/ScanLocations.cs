...
namespace JMS.DVB
{
    ...
    public class ScanLocations : ICloneable
    {
        ...
        {
            // Create serializer
            XmlSerializer serializer = new(GetType(), Namespace);
        ...
        {
            // Create serializer
            XmlSerializer serializer = new(typeof(ScanLocations), Namespace);
        ...
        private static ScanLocations Load()
        {
            ...
            {
                // Get all files
                List<FileInfo> files = new(locations.GetFiles("*.dss"));
