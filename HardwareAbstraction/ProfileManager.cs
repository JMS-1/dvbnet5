...
namespace JMS.DVB
{
    ...
    public static class ProfileManager
    {
        ...
        /// </summary>
        public static int RefreshCounter => _RefreshCounter;
        ...
        public static Profile? FindProfile(string name) => Array.Find(AllProfiles, p => ProfileNameComparer.Equals(p.Name, name));
