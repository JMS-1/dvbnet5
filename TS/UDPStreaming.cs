...
namespace JMS.DVB.TS
{
    ...
    public class UDPStreaming
    {
        ...
        private class ConnectionInfo(string client, int port, Socket socket, EndPoint target)
        {
            ...
            /// <summary>
            /// Die zugeh�rige Netzwerkverbindung.
            /// </summary>
            public Socket Socket { get; private set; } = socket;

            /// <summary>
            /// Die zugeh�rige Empfangsadresse.
            /// </summary>
        ...
        /// <summary>
        /// Daten werden grunds�tzlich in diesen Einheiten verschickt.
        /// </summary>
        public const int BufferSize = 40 * Manager.FullSize;

        /// <summary>
        /// Die aktuell g�ltige Netzwerkverbindung.
        /// </summary>
        ...
        /// <summary>
        /// Hops, die ein Multicast-Paket �berpringen darf.
        /// </summary>
        ...
        /// </summary>
        /// <param name="multicastTTL">Hops, die ein Multicast Paket �berpringen darf.</param>
        /// <param name="maxQueue">Die maximal erlaubte L�nge der Warteschlange.</param>
        ...
        /// <summary>
        /// �bertr�gt Daten in die Warteschlange.
        /// </summary>
        /// <remarks>Der Aufrufer h�lt alle notwendigen Sperren.</remarks>
        /// <returns>Gesetzt, wenn die Daten �bertragen werden konnten.</returns>
        ...
        /// </summary>
        /// <param name="client">Empf�ngerrechner oder IP Adresse.</param>
        /// <param name="port">TCP/IP Port des Empf�ngers</param>
