namespace JMS.DVB.TS
{
    ...
    public interface IStreamConsumer
    {
        ...
        /// </summary>
        /// <param name="counter">Paketz�hler f�r den zugeordneten Datenstrom im <i>Transport Stream</i>.</param>
        ...
        /// <param name="packs">Die Anzahl der <i>Transport Stream</i> Pakete, die zu �bertragen sind.</param>
    ...
    /// <summary>
    /// Erweiterte Schnittstelle f�r Verbraucher von voranalysierten PES Paketstr�men.
    /// </summary>
    public interface IStreamConsumer2 : IStreamConsumer
    {
        /// <summary>
        /// Gesetzt, wenn keine Analyse des Paketstroms erw�nscht ist.
        /// </summary>
