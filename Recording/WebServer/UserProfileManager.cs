...
namespace JMS.DVB.NET.Recording.RestWebApi
{
    ...
    public class UserProfileManager : ProfileProvider
    {
        ...
        /// <summary>
        /// Globale Sperre f�r Dateizugriffe.
        /// </summary>
        private static object m_FileLock = new object();

        /// <summary>
        /// Der Name der zugeh�rigen Anwendung.
        /// </summary>
        ...
        /// <summary>
        /// Wird zum L�schen von Benutzerprofilen aufgerufen und macht in dieser Implementierung
        /// gar nichts.
        /// </summary>
        ...
        /// gar nichts.
        /// </summary>
        /// <param name="profiles">Eine Sammlung der zu l�schenden Profile..</param>
        /// <returns>Die Anzahl der entfernten Profile.</returns>
        public override int DeleteProfiles(ProfileInfoCollection profiles) => 0;

        /// <summary>
        /// J�scht nicht mehr verwendete Benutzerprofile.
        /// </summary>
        /// <param name="authenticationOption">Die Art der Benutzerauthentisierung.</param>
        /// <param name="userInactiveSinceDate">Das Bezugsdatum f�r die Pr�fung auf Inaktivit�t.</param>
        /// <returns>Die Anzahl der entfernten Profile.</returns>
        ...
        /// <summary>
        /// Erzeugt eine leere Auflistung f�r Benutzerprofile.
        /// </summary>
        /// <param name="totalRecords">Meldet die gesamte Anzahl von Eintr�gen.</param>
        ...
        /// </summary>
        /// <param name="authenticationOption">Die Art der Benutzerauthentisierung.</param>
        /// <param name="pageIndex">Die aktuelle Seite in der Liste zum Durchbl�ttern.</param>
        ...
        /// <returns>Eine auflistung mit den gew�nschten Profilen.</returns>
        ...
        /// </summary>
        /// <param name="authenticationOption">Die Art der Benutzerauthentisierung.</param>
        /// <param name="userInactiveSinceDate">Das Datum zur Feststellung der Inaktivit�t.</param>
        /// <param name="pageIndex">Die aktuelle Seite in der Liste zum Durchbl�ttern.</param>
        /// <param name="pageSize">Die Anzahl der Profile pro Seite.</param>
        /// <param name="totalRecords">Meldet die gesamte Anzahl von Profilen.</param>
        /// <returns>Eine auflistung mit den gew�nschten Profilen.</returns>
        ...
        /// <summary>
        /// Ermittelt alle Eintr�ge aus einem Benutzerprofil.
        /// </summary>
        /// <param name="context">Informationen zur aktuellen Arbeitsumgebung.</param>
        /// <param name="collection">Alle ben�tigten Eigenschaften aus dem Profil.</param>
        /// <returns>Eine Auflistung der gew�nschten Eigenschaften und den zugeh�rigen Werten.</returns>
        ...
        /// <summary>
        /// �ndert Einstellungen im Benutzerprofil.
        /// </summary>
        /// <param name="context">Die aktuelle Arbeitsumgebung.</param>
        /// <param name="collection">Die Einstellungen und die zugeh�rigen Werte, wie sie zu aktualisieren sind.</param>
