...
namespace JMS.DVB.NET.Recording.Persistence
{
    ...
    public class VCRSchedule
    {
        ...
        /// <summary>
        /// Fùr sich wiederholende Aufzeichnungen das frùheste Datum, an dem die
        /// nùchste Aufzeichnung stattfinden darf.
        /// </summary>
        public DateTime? NoStartBefore { get; set; }

        /// <summary>
        /// Datum und Uhrzeit, wann die Aufzeichnung das erste Mal ausgefùhrt werden soll.
        /// </summary>
        public DateTime FirstStart { get; set; }

        /// <summary>
        /// Datum, an dem die Aufzeichnung das letzte Mal ausgefùhrt werden soll.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Die gewùnschte Quelle.
        /// </summary>
        public SourceSelection Source { get; set; }

        /// <summary>
        /// Die Datenstrùme, die aufgezeichnet werden sollen.
        /// </summary>
        ...
        /// <summary>
        /// Alle Ausnahmeregeln fùr eine sich wiederholende Aufzeichnung.
        /// </summary>
        [XmlElement("Exception")]
        public readonly List<VCRScheduleException> Exceptions = new List<VCRScheduleException>();

        /// <summary>
        /// Prùft, ob die Daten zur Aufzeichnung zulùssig sind.
        /// </summary>
        /// <param name="job">Der zugehùrige Auftrag.</param>
        ...
        /// <summary>
        /// Setzt den nùchsten mùglichen Zeitpunkt fùr eine Wiederholung der Aufzeichnung.
        /// </summary>
        [XmlIgnore]
        ...
        /// <summary>
        /// Prùft, ob diese Aufzeichnung noch einmal verwendet wird.
        /// </summary>
        [XmlIgnore]
        ...
        /// <summary>
        /// Meldet, ob fùr diese Aufzeichnung eine Wiederholung definiert ist.
        /// </summary>
        [XmlIgnore]
        private bool IsRepeatable => Days.HasValue && ((int)Days.Value != 0);

        /// <summary>
        /// Prùft, ob eine Aufzeichnung an dem angegebenen Wochentag erlaubt ist.
        /// </summary>
        ...
        /// <returns>Die zugehùrige Kennzeichnung.</returns>
        public static VCRDay GetDay(DayOfWeek day) => m_DayMapper[day];

        /// <summary>
        /// Ermittelt, ob fùr einen bestimmten Tag eine Ausnahme definiert ist.
        /// </summary>
        /// <param name="day">Der gewùnschte Tag.</param>
        /// <returns>Die Ausnahme fùr diesen Tag oder <i>null</i>, wenn eine regulùre Aufzeichnung ausgefùhrt
        /// werden soll.</returns>
        ...
        /// <summary>
        /// Ermittelt die Ausnahmeregel fùr einen bestimmten Tag.
        /// </summary>
        /// <param name="recordingEnd">Der Endzeitpunkt einer Aufzeichnung.</param>
        /// <returns>Die zugehùrige Ausnahmeregel.</returns>
        ...
        /// <summary>
        /// Trùgt eine Ausnahmeregelung fùr einen bestimmten Tag ein.
        /// </summary>
        /// <param name="day">Der gewùnschte Tag.</param>
        /// <param name="exception">Die Ausnahmeregel oder <i>null</i>, wenn fùr den Tag keine Ausnahme
        ...
        /// </summary>
        /// <returns>Die gewùnschte Liste oder <i>null</i>, falls keinerlei Wiederholung erwùnscht ist.</returns>
        ...
        /// <param name="job">Der zugehùrige Auftrag.</param>
        /// <param name="devices">Die Liste der Gerùte, auf denen die Aufzeichnung ausgefùhrt werden darf.</param>
        /// <param name="findSource">Dient zum Prùfen einer Quelle.</param>
        /// <param name="disabled">Alle deaktivierten Auftrùge.</param>
