...
namespace JMS.DVB.NET.Recording.RestWebApi
{
    ...
    public class ZappingController(VCRServer server) : ControllerBase
    {
        ...
        [HttpGet]
        public ZappingStatus GetCurrentStatus(string detail) => server.LiveModeOperation(detail, true, null!, null!, ZappingStatus.Create);
        ...
        [HttpGet]
        public ZappingSource[] FindSources(string detail, bool tv, bool radio) => server.GetSources(detail, tv, radio, ZappingSource.Create);
        ...
        /// <returns>Der Zustand auf dem gewählten Geräteprofil.</returns>
        [HttpPost]
        public ZappingStatus Connect(string detail, string target) => server.LiveModeOperation(detail, true, target, null!, ZappingStatus.Create);
        ...
        /// <returns>Der Zustand auf dem gewählten Geräteprofil.</returns>
        [HttpDelete]
        public ZappingStatus Disconnect(string detail) => server.LiveModeOperation(detail, false, null!, null!, ZappingStatus.Create);
        ...
        /// <returns>Der Zustand auf dem gewählten Geräteprofil.</returns>
        [HttpPut]
        public ZappingStatus Tune(string detail, string source) => server.LiveModeOperation(detail, true, null!, SourceIdentifier.Parse(source), ZappingStatus.Create);
    }
}
